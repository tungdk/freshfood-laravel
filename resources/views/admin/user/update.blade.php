                                ...
                                <div class="box-body">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group {{ $errors->first('name') ? 'has-error' : ''}}">
                                            ...
                                            <input type="email" class="form-control" name="email" placeholder="nxtho0109@gmail.com..." value="{{ $user->email }}">
                                        ...
                                        <div class="form-group {{ $errors->first('name') ? 'has-error' : ''}}">
                                            ...
                                            <input type="text" class="form-control" name="phone" placeholder="0247004230..." value="{{ $user->phone }}">
                                        ...
                                        <div class="form-group {{ $errors->first('name') ? 'has-error' : ''}}">
                                            ...
                                            <input type="password" class="form-control" name="pasword" value="{{ $user->password }}">
