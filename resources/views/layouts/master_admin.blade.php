    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="{{route('admin.statistical')}}" class="logo">
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="navbar-custom-menu">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <button style="margin-top: 10px" class="btn btn-success"><a href="{{route('home')}}" style="color: Red">Trang chủ</a></button>
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            <li>
                                                ...
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="{{asset('public/backend/dist/img/anhdaidien.jpg')}}" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                                        Support Team
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="{{asset('public/backend/dist/img/anhdaidien.jpg')}}" class="user-image" alt="User Image">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                          Ảnh đại diện
                                            <small>BKAP-PROJECT-LARAVEL</small>
                                        </p>
                                    </li>
                                    <!-- Menu Body -->
{{--                                    <li class="user-body">--}}
...
{{--                                        </div>--}}
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="">
                            <a href="{{ route('admin.subcategory.index') }}">
                                <i class="fa fa-edit"></i> <span>Danh mục con</span>
                            </a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a href="{{ route('admin.unit.index') }}">
                                <i class="fa fa-database"></i> <span>Đơn vị</span>
                            </a>
                        </li>
                        <li class="">
                        ...
                        <li class="">
                            <a href="{{ route('admin.order.index') }}">
                                <i class="fa fa-user"></i> <span>Đặt hàng</span>
                            </a>
                        </li>
                        ...
                        <li class="">
                            <a href="{{ route('admin.rating.index') }}">
                                <i class="fa fa-edit"></i> <span>Xếp hạng</span>
                            </a>
                        </li>
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $(".js-preview-order").click(function(event){
                    ...
                    .done(function( results ) {
                        $("#modal-preview-order .content").html(results.html)
                        $("#modal-preview-order").modal({
                            show:true
                        });
                    });

                });
                $('body').on("click",'.js-delete-order-detail',function(){
                    event.preventDefault();
                    let $this=$(this);
                    let URL=$this.attr('href');
                    $.ajax({
